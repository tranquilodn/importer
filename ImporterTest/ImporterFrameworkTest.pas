...
type
  ...
  public
    ...
    [Test]
    [WillRaise(ENullPointerException)]
    procedure AddFieldTest_ENullPointerException;

    [Test]
    [WillRaise(EFieldNameMustBeUniqueException)]
    procedure AddFieldTest_SameName_EFieldNameMustBeUniqueException;

    [Test]
    [WillRaise(EFieldNameMustBeUniqueException)]
    procedure AddFieldTest_SameName_DifferentUpperLowerCase_EFieldNameMustBeUniqueException;
